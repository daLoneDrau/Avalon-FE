...
angular.module('restApp').controller('ArmorController', function($scope, $window, itemService, $q, $http) {
    $scope.newEntity = {
    		title: "",
    		attack_method: {},
            ...
            if (response.status === 200) {
                ...
                for (var i = response.data.length - 1; i >= 0; i--) {
                	...
                	for (var j = obj.types.length - 1; j >= 0; j--) {
                		if (obj.types[j].code === "OBJECT_TYPE_ARMOR") {
                			isArmor = true;
                			break;
                		}
                	}
                    ...
                    if (angular.isUndefined(obj.price_destroyed)) {
                        obj.price_destroyed = 0;
                    }
